...
public class MatchingRuleTest {
	...
	public void noPrivilegesChangedTest() {
		try (Transaction tx = persistence.createTransaction()) {
			...
			UserSynchronizationResultDto userSynchronizationResultDto = syncUser("bobh", true);
	...
	private UserSynchronizationResultDto syncUser(String login, boolean saveSynchronizationResult) {
		return userSynchronizationService.synchronizeUser(login, saveSynchronizationResult, null,
				null, null);
	}
}
