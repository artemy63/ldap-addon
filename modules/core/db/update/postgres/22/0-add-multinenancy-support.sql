...
ALTER TABLE LDAP_MATCHING_RULE ADD LDAP_CONFIG_ID uuid^
ALTER TABLE LDAP_USER_ATTRIBUTE ADD LDAP_CONFIG_ID uuid^
...
CREATE UNIQUE INDEX IDX_LDAP_LDAP_CONFIG_UNIQ_SYS_TENANT_ID on LDAP_LDAP_CONFIG (SYS_TENANT_ID) WHERE SYS_TENANT_ID IS NOT NULL^
