...
ALTER TABLE LDAP_MATCHING_RULE ADD LDAP_CONFIG_ID varchar(36)^

ALTER TABLE LDAP_USER_ATTRIBUTE ADD LDAP_CONFIG_ID varchar(36)^
...
ALTER TABLE LDAP_MATCHING_RULE
    ADD CONSTRAINT FK_LDAP_MATCHING_RULE_LDAP_LDAP_CONFIG FOREIGN KEY (LDAP_CONFIG_ID) REFERENCES LDAP_LDAP_CONFIG(ID) ON DELETE CASCADE^
ALTER TABLE LDAP_USER_ATTRIBUTE
    ADD CONSTRAINT FK_LDAP_USER_ATTRIBUTE_LDAP_LDAP_CONFIG FOREIGN KEY (LDAP_CONFIG_ID) REFERENCES LDAP_LDAP_CONFIG (ID) ON DELETE CASCADE^